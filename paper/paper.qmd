...
# modelsummary(BIC_model, output = "default", table.font.size = 4)

modelsummary(BIC_model, output = "kableExtra", statistics = NULL) |>
    kable_styling(font_size = 8, full_width = FALSE, bootstrap_options = "striped", position = "center") |>
